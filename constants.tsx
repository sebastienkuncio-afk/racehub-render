...
import type { Race, NavLink } from './types.ts';
...
export const NAV_LINKS: NavLink[] = [
  { name: 'Rules', href: '#', icon: BookIcon },
  { name: 'Dashboard', href: '#', icon: HomeIcon },
  { name: 'Strategy', href: '#', icon: ClipboardIcon },
  { name: 'Script', href: '#', icon: CodeIcon },
];
...
export const MOCK_RACES: Race[] = [
  {
    ...
    imageUrl: 'https://picsum.photos/seed/monaco/400/200',
    status: 'Finished',
  },
  {
    id: 2,
    ...
    imageUrl: 'https://picsum.photos/seed/indy/400/200',
    status: 'Finished',
  },
  {
    id: 3,
    ...
    imageUrl: 'https://picsum.photos/seed/lemans/400/200',
    status: 'Live',
  },
  {
    id: 4,
    ...
    imageUrl: 'https://picsum.photos/seed/silverstone/400/200',
    status: 'Upcoming',
  },
  {
    id: 5,
    ...
    imageUrl: 'https://picsum.photos/seed/spa/400/200',
    status: 'Upcoming',
  },
  {
    id: 6,
    ...
    imageUrl: 'https://picsum.photos/seed/monza/400/200',
    status: 'Upcoming',
  },
];